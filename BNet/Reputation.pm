...
sub reputation_vanilla ($%) {
	...
	BNet::Utils::preprintreputation($count, '1419', "Bizmo's Brawlpub (Mists)", %multirep);
	BNet::Utils::preprintreputation($count, '1691', "Bizmo's Brawlpub (Warlords)", %multirep);
	BNet::Utils::preprintreputation($count, '2011', "Bizmo's Brawlpub (Legion)", %multirep);
	BNet::Utils::preprintreputation($count, '2371', "Bizmo's Brawlpub  (BFA)", %multirep);
	...
	BNet::Utils::preprintreputation($count, '1374', "Brawl'gar Arena (Mists)", %multirep);
	BNet::Utils::preprintreputation($count, '1690', "Brawl'gar Arena (Warlords)", %multirep);
	BNet::Utils::preprintreputation($count, '2010', "Brawl'gar Arena (Legion)", %multirep);
	BNet::Utils::preprintreputation($count, '2372', "Brawl'gar Arena (BFA)", %multirep);
