...
sub raid_dungeon_bosses ($%) {
	...
	BNet::Utils::groupheader ("Raids: Cataslysm");
	...
	BNet::Utils::preprintachievement ($count, '16248', '5118', "Halfus Wyrmbreaker", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '16249', '5118', "Halfus Wyrmbreaker", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Valiona and Theralion");
	BNet::Utils::preprintachievement ($count, '16278', '5117', "Valiona and Theralion", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '16279', '5117', "Valiona and Theralion", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Ascendant Council");
	BNet::Utils::preprintachievement ($count, '16282', '5119', "Twilight Ascendant Council", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '16283', '5119', "Twilight Ascendant Council", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Cho'gall");
	BNet::Utils::preprintachievement ($count, '16284', '5120', "Cho'gall", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '16285', '5120', "Cho'gall", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Sinestra");
	BNet::Utils::preprintachievement ($count, '16288', '5121', "Sinestra", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '16289', '5121', "Sinestra", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Conclave of Wind");
	BNet::Utils::preprintachievement ($count, '16290', '5122', "Conclave of Wind", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '16291', '5122', "Conclave of Wind", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Al'Akir");
	BNet::Utils::preprintachievement ($count, '16296', '5123', "Al'Akir", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '16297', '5123', "Al'Akir", %multiusercriteria);
	...
	BNet::Utils::preprintachievement ($count, '18050', '5807', "Beth'tilac", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '18051', '5807', "Beth'tilac", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Lord Rhyolith");
	BNet::Utils::preprintachievement ($count, '18054', '5808', "Lord Rhyolith", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '18055', '5808', "Lord Rhyolith", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Shannox");
	BNet::Utils::preprintachievement ($count, '18058', '5806', "Shannox", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '18059', '5806', "Shannox", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Alysrazor");
	BNet::Utils::preprintachievement ($count, '18062', '5809', "Alysrazor", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '18063', '5809', "Alysrazor", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Baleroc");
	BNet::Utils::preprintachievement ($count, '18066', '5805', "Baleroc", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '18067', '5805', "Baleroc", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Majordomo Fandral Staghelm");
	BNet::Utils::preprintachievement ($count, '18070', '5804', "Majordomo Fandral Staghelm", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '18071', '5804', "Majordomo Fandral Staghelm", %multiusercriteria);
	BNet::Utils::groupheader ("Heroic: Ragnaros");
	BNet::Utils::preprintachievement ($count, '18074', '5803', "Ragnaros", %multiusercriteria);
	BNet::Utils::preprintachievement ($count, '18075', '5803', "Ragnaros", %multiusercriteria);
