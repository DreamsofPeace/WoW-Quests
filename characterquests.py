...
def charquestsoutput(count,datatree,outputfile):
	...
	charquestheader(count,"Dragonflight Launch Quest",openfile)
	charquestprintfaction(count,datatree,openfile,66586,"Legacy of Tyr: Secrets of the Past","horde")
	charquestprintfaction(count,datatree,openfile,66548,"Legacy of Tyr: Secrets of the Past","alliance")
